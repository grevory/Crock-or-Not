...
function _json ($input)
{
  // Make outputing errors to JSON easy making the input a string instead of an array with an "error" key
  if ( ! is_array($input))
    $input = array('error',$input);
  
  // The first two headers prevent browser caching
